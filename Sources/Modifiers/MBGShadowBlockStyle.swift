...
public struct ShadowBlockStyle: Sendable {
    ...
    public static let inspectorDefault = ShadowBlockStyle(
        radius: 12,
        x: 0,
        y: 6,
        opacity: 0.30
...
public struct ShadowBlockModifier<S: Shape>: ViewModifier {

    public var shape: S
    public var fill: Color
    public var shadow: ShadowBlockStyle

    public init(shape: S,
                fill: Color,
                shadow: ShadowBlockStyle) {
        self.shape = shape
        self.fill = fill
        self.shadow = shadow
    }
